...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquare.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            // If activePlayer id equal to 'X', the x.png is placed in HTML.
        ...
        // squareNumber and activePlayer are concatenated together abd added t0 array.
    ...
    function computersTurn() {
        ...
        while(!success) {
            // A random number between 0 and 8 is selcted
            pickASquare = String(Math.floor(Math.random() * 9));
            // If the random number evaluates returns ture, the square hasn't been placed yet.
...
function checkWinConditions() {
    ...
    // X 0, 3, 6 conditon
    else if (arrayIncludes('1X', '3X', '6X')) { drawWinLine(100, 50, 100, 558); }
    // X 1, 4, 7 conditon
    ...
    // O 0, 3, 6 conditon
    else if (arrayIncludes('1O', '3O', '6O')) { drawWinLine(100, 50, 100, 558); }
    // O 1, 4, 7 conditon
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        // returned and our ellse if condition executes the drawWineLine function.
...
function drawWinLine(coordX1,coordY1,coordX2,coordY2) {
    ...
    // This line indicates where the X axis line starts.
    let x1 = coordX1,
        // This line indicates where the Y axis line starts.
        y1 = coordY1,
        // This line indicates where the X axis line ends.
        x2 = coordX2,
        // This line indicates where the Y axis line ends.
        y2 = coordY2,
    ...
    // This function interacts with trhe canvas
